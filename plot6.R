...
Comp_Road_Obs <- data.frame(matrix(nrow=8,ncol = 3))
colnames(Comp_Road_Obs) = c("Year","City","Emissions")
Comp_Road_Obs[1:8,1] = c(1999,2002,2005,2008)  #year values
Comp_Road_Obs[1:4,2] = rep("Baltmore",4)
Comp_Road_Obs[5:8,2] = rep("Los Angeles",4)
